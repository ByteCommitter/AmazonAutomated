...
Results:
----- SEARCH RESULTS PANEL INFO -----
No suitable product name candidates found
Product Price: ₹5,999
Trying UiAutomator approach as fallback...
Found panel with resource ID pattern, attempting deeper inspection
---------------------------------

----- PRODUCT DETAILS -----
Product Title: JLab JBuds LUX ANC Smart Active Noise Cancelling Headphones - Over Ear Wireless Headphones with Microphone, 70+ H Playtime Foldable Bluetooth Earphones with Multipoint & Customisable Sound, Graphite
